...
async def main():
    ...
    async with AzureAIAgentClient(credential=credential) as chat_client:
        ...
        action = chat_client.as_agent(instructions=action_instructions, name="actions")

        feedback="I use the dashboard everyday to monitor metrics, and it works well overall. But when I'm working late at night the bright screen is really harsh on my eyes. If you added a dark mode option, it would make the experience much more comfortable."
